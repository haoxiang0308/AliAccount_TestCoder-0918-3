...
# Save the filtered DataFrame to the randomly named file in a proper format
with open(random_filename, 'w') as f:
    f.write("# Filtered DataFrame saved to this file\n\n")
    f.write("import pandas as pd\n\n")
    # Convert the DataFrame to a dictionary format that can be reconstructed
    f.write("data = " + str(filtered_df.to_dict('records')) + "\n")
    f.write("filtered_df = pd.DataFrame(data)\n\n")
    f.write("print('Filtered data:')\n")
