...
def main():
    ...
    # Also create the Python script with OpenCV functionality and save it with a random name
...
def load_display_save_image():
    # Load an image (this assumes you have an image in the working directory)
