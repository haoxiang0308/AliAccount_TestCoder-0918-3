...
try:
    client = MongoClient('mongodb://localhost:27017/', serverSelectionTimeoutMS=5000) # Short timeout for testing
    ...
    # Close the connection after successful insert (or if we reach this point)
    client.close()
    print("Connected to MongoDB and inserted document.")

except Exception as e:
    print(f"Could not connect to MongoDB or insert document: {e}. Proceeding to generate the file.")
