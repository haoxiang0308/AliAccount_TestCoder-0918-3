...
'''
    ...
    print(f"\\nTensorFlow linear regression script saved as: {random_filename}")
    print("The script contains a simple model definition and will generate another randomly named file when executed.")