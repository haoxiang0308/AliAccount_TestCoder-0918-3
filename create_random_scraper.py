#!/usr/bin/env python3
"""
Script to create a randomly named Python file with BeautifulSoup scraping functionality
"""
import random
import string
import os
...
def get_scraper_code():
    """Return the content of the scraper script."""
...
def main():
    ...
    print(f"Created randomly named scraper file: {random_filename}")
