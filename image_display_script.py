...
def main():
    ...
    # This would normally save itself with a new random name
    # but for safety we'll just print the intended name
    print(f"Would save this script as: {random_script_name}")
...
'''
    ...
    print(f"Saved this script with random name: {random_script_name}")
